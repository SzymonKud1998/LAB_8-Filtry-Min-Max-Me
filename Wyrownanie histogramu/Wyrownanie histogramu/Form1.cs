...
namespace Wyrownanie_histogramu
{
    public partial class Form1 : Form
    {
        ...
        {
            //algorytm minimum
            Bitmap b1 = (Bitmap)pictureBox_1.Image;
            Bitmap b2 = (Bitmap)pictureBox_2.Image;
            Color[,] k = new Color[3, 3];
            int r = 0, g = 0, b = 0;
            int[] red = new int[9];
            int[] green = new int[9];
            ...
            for (int x = 0; x < pictureBox_1.Image.Width; x++)
            {
                if (x == 0 || x == pictureBox_1.Image.Width - 1)
                {
                    continue;
                }
                for (int y = 0; y < pictureBox_1.Image.Height; y++)
                {
                    if (y == 0 || y == pictureBox_1.Image.Height - 1)
                    {
                        continue;
                    }
                    indeks = 0;
        ...
        private void Maksimum_click(object sender, EventArgs e)
        {
            //algorytm maksimum
            Bitmap b1 = (Bitmap)pictureBox_1.Image;
            Bitmap b2 = (Bitmap)pictureBox_2.Image;
